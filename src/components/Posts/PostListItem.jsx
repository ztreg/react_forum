...
import { FaArrowAltCircleRight, FaCheck, FaCommentAlt, FaCross, FaMapPin, FaRegEye } from 'react-icons/fa';
    ...
    <StyledNewsListItem isPinned={isPinned}>
      ...
      <>
        ...
        <div className="sidePart">
          <p>{isPinned ? <FaMapPin /> : ''}</p>
          <strong> Author: {props.post.author === null ? 'No author given' : fullName}</strong> 
          <p>Created: <TimeAgo datetime={props.post.createdAt} locale='sv-SV' /></p>
